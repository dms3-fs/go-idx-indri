...
// MetadataPair.i
//
// renamed and adapted MetadataPairVector.i, 24 August 2004 -- tds
// see new MetadataPairVector.i for GO metadata pair vector.
// tds JAVA metadata pair vector code is still retained here.
//
